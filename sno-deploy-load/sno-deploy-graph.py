...
def main():
  ...
  parser.add_argument("--hub-version", type=str, default="4.10.6", help="Sets OCP Hub version for graph title")
  parser.add_argument("--sno-version", type=str, default="4.10.6", help="Sets OCP SNO version for graph title")
