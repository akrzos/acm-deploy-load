...
def main():
  ...
  parser.add_argument("--hub-version", type=str, default="4.10.7", help="Sets OCP Hub version for report")
  parser.add_argument("--sno-version", type=str, default="4.10.7", help="Sets OCP SNO version for report")
